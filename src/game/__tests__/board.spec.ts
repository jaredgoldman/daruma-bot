...
// // Tests variables
// const rolls = [
//   { damage: 1, roll: 0, totalScore: 0 },
//   { damage: 2, roll: 0, totalScore: 0 },
//   { damage: 3, roll: 0, totalScore: 0 },
//   { damage: 4, roll: 0, totalScore: 0 },
//   { damage: 5, roll: 0, totalScore: 0 },
//   { damage: 6, roll: 0, totalScore: 0 },
//   { damage: 7, roll: 0, totalScore: 0 },
//   { damage: 8, roll: 0, totalScore: 0 },
//   { damage: 9, roll: 0, totalScore: 0 },
//   { damage: 10, roll: 0, totalScore: 0 },
// ]
...
// describe('Test suite for total roll row', () => {
//   it('correctly calculates row total', () => {
//     const rolls = [
//       { damage: 1, roll: 0, totalScore: 0 },
//       { damage: 2, roll: 0, totalScore: 0 },
//       { damage: 3, roll: 0, totalScore: 0 },
//       { damage: 4, roll: 0, totalScore: 0 },x
//       { damage: 5, roll: 0, totalScore: 0 },
//       { damage: 6, roll: 0, totalScore: 0 },
//       { damage: 7, roll: 0, totalScore: 0 },
//       { damage: 8, roll: 0, totalScore: 0 },
...
//     console.log(rolls.slice(0, -3))
//     expect(findRoundTotal(rolls.slice(0, 2))).toEqual(6)
//   })
// })
